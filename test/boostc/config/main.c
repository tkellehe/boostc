...
int main(int argc, char *argv[])
{
    ...
    //--------------------------------------------------------------------------------------------------------
    printf("BSTC_GCD_X2(4, 8): %i\n", (int)BSTC_GCD_X2(4, 8));
    #if BSTC_GCD_X2(4, 8) == 4
    (++num_pass, printf("    passed\n"));
    #else
    (++num_fail, printf("    failed\n"));
    #endif
    printf("BSTC_GCD_X4(2000, 100): %i\n", (int)BSTC_GCD_X4(2000, 100));
    #if BSTC_GCD_X4(2000, 100) == 100
    (++num_pass, printf("    passed\n"));
    #else
    (++num_fail, printf("    failed\n"));
    #endif
    printf("BSTC_GCD_X4(101, 31): %i\n", (int)BSTC_GCD_X4(101, 31));
    #if BSTC_GCD_X4(101, 31) == 1
    (++num_pass, printf("    passed\n"));
    #else
    (++num_fail, printf("    failed\n"));
    #endif
    printf("BSTC_GCD_X6(2*3*4*5+5, 5): %i\n", (int)BSTC_GCD_X6(2*3*4*5+5, 5));
    #if BSTC_GCD_X6(2*3*4*5+5, 5) == 5
    (++num_pass, printf("    passed\n"));
    #else
    (++num_fail, printf("    failed\n"));
    #endif
    #ifdef BSTC_GCD_X16
        printf("BSTC_GCD_X16(2746409537, 411147833): %i\n", (int)BSTC_GCD_X16(2746409537, 411147833));
        #if BSTC_GCD_X16(2746409537, 411147833) == 1
        (++num_pass, printf("    passed\n"));
        #else
        (++num_fail, printf("    failed\n"));
        #endif
