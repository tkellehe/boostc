...
//     // #define vtraits3 bstc_vect_traits(float, bstc_ctuple(my_free, my_malloc, my_realloc))

//     // //--------------------------------------------------------------------------------------------------------
//     // printf("bstc_vect_traits(int): %s\n", bstc_ctuple_tostring(vtraits1));
//     // bstc_tmplt_isa(vtraits1, (++num_pass, printf("    passed\n")), (++num_fail, printf("    failed\n")));
//     // printf("bstc_vect_traits(float, bstc_alloc_defaults): %s\n", bstc_ctuple_tostring(vtraits2));
//     // bstc_tmplt_isa(vtraits2, (++num_pass, printf("    passed\n")), (++num_fail, printf("    failed\n")));
...
//     // bstc_tmplt_isa(vtraits3, (++num_pass, printf("    passed\n")), (++num_fail, printf("    failed\n")));
...
//     //         iter = bstc_vect_begin(vect);
//     //         bstc_alg_foreach(bstc_tmplt_iter(vtraits1), iter, bstc_vect_end(vect),
...
//     //         riter = bstc_vect_rbegin(vect);
//     //         bstc_alg_foreach(bstc_tmplt_riter(vtraits1), riter, bstc_vect_rend(vect),
//     //             --i;
...
//     //         iter = bstc_vect_begin(vect);
//     //         bstc_alg_find(bstc_tmplt_iter(vtraits1), iter, bstc_vect_end(vect), 3)
//     //         if(iter != bstc_vect_end(vect) && bstc_vect_iter_val(iter) == 3)  ++num_pass, printf("    passed\n"); else ++num_fail, printf("    failed\n");
//     //         printf("bstc_alg_find(iter, 100):\n");
//     //         iter = bstc_vect_begin(vect);
//     //         bstc_alg_find(bstc_tmplt_iter(vtraits1), iter, bstc_vect_end(vect), 100)
...
//     //         riter = bstc_vect_rbegin(vect);
//     //         bstc_alg_find(bstc_tmplt_riter(vtraits1), riter, bstc_vect_rend(vect), 3)
//     //         if(riter != bstc_vect_rend(vect) && bstc_vect_riter_val(riter) == 3)  ++num_pass, printf("    passed\n"); else ++num_fail, printf("    failed\n");
//     //         printf("bstc_alg_find(riter, 100):\n");
//     //         riter = bstc_vect_rbegin(vect);
//     //         bstc_alg_find(bstc_tmplt_riter(vtraits1), riter, bstc_vect_rend(vect), 100)
