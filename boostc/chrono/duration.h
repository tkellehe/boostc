...
# ifdef BSTC_HAS_VARIADIC_MACROS
#  define bstc_chrono_dur_per(tpl) BSTC_EXPAND(BSTC_GET_ARG0 tpl)
# else
...
# if bstc_intmax_max >= bstc_uint32_max && defined(bstc_nano)
#  define bstc_chrono_ns BSTC_CTUPLE2(bstc_uint_least64_t, bstc_nano)
# endif
#endif


#ifndef bstc_chrono_us
# if bstc_intmax_max >= bstc_uint32_max && defined(bstc_micro)
#  define bstc_chrono_us BSTC_CTUPLE2(bstc_uint_least64_t, bstc_micro)
# endif
#endif


#ifndef bstc_chrono_ms
# if bstc_intmax_max >= bstc_uint16_max && defined(bstc_milli)
#  define bstc_chrono_ms BSTC_CTUPLE2(bstc_uint_least64_t, bstc_milli)
# endif
#endif


#ifndef bstc_chrono_sec
# if defined(bstc_uint_least64_t)
#  define bstc_chrono_sec BSTC_CTUPLE2(bstc_uint_least64_t, BSTC_CTUPLE2(bstc_ratio_c(1), bstc_ratio_c(1)))
# endif
#endif


#ifndef bstc_chrono_min
# if defined(bstc_uint_least32_t)
#  define bstc_chrono_min BSTC_CTUPLE2(bstc_uint_least32_t, BSTC_CTUPLE2(bstc_ratio_c(60), bstc_ratio_c(1)))
# endif
#endif
...
# if defined(bstc_uint_least32_t)
#  define bstc_chrono_hrs BSTC_CTUPLE2(bstc_uint_least32_t, BSTC_CTUPLE2(bstc_ratio_c(3600), bstc_ratio_c(1)))
# endif
#endif
...
# if defined(bstc_uint_least32_t)
#  define bstc_chrono_days BSTC_CTUPLE2(bstc_uint_least32_t, BSTC_CTUPLE2(bstc_ratio_c(86400), bstc_ratio_c(1)))
# endif
#endif
...
# if defined(bstc_uint_least32_t)
#  define bstc_chrono_weeks BSTC_CTUPLE2(bstc_uint_least32_t, BSTC_CTUPLE2(bstc_ratio_c(604800), bstc_ratio_c(1)))
# endif
#endif
...
# if defined(bstc_uint_least32_t)
#  define bstc_chrono_months BSTC_CTUPLE2(bstc_uint_least32_t, BSTC_CTUPLE2(bstc_ratio_c(2629746), bstc_ratio_c(1)))
# endif
#endif
...
# if defined(bstc_uint_least32_t)
#  define bstc_chrono_years BSTC_CTUPLE2(bstc_uint_least32_t, BSTC_CTUPLE2(bstc_ratio_c(31556952), bstc_ratio_c(1)))
# endif
#endif
/// \}
